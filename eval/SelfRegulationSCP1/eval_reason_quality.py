...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="Run evaluation on SelfRegulationSCP1 inference results",
        formatter_class=argparse.RawDescriptionHelpFormatter
    )
    parser.add_argument(
        "--inference-files", "-i",
        nargs="+",
        default=['/path/to/inference_results_1.json', '/path/to/inference_results_2.json'],
        help="List of inference result files"
    )
    parser.add_argument(
        "--output-files", "-o",
        nargs="+",
        default=['/path/to/eval_output_1.json', '/path/to/eval_output_2.json'],
